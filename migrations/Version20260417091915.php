 ...
 */
final class Version20260417091915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE anime_genre (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE anime_theme (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE episode_show (id INT AUTO_INCREMENT NOT NULL, show_date DATETIME NOT NULL, user_id INT NOT NULL, episode_id INT NOT NULL, INDEX IDX_56D84521A76ED395 (user_id), INDEX IDX_56D84521362B62A0 (episode_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE game_player_perspective (game_id INT NOT NULL, player_perspective_id INT NOT NULL, INDEX IDX_6884435DE48FD905 (game_id), INDEX IDX_6884435D210F5D42 (player_perspective_id), PRIMARY KEY (game_id, player_perspective_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE game_igdbgenre (game_id INT NOT NULL, igdbgenre_id INT NOT NULL, INDEX IDX_61F649B3E48FD905 (game_id), INDEX IDX_61F649B33AEC1213 (igdbgenre_id), PRIMARY KEY (game_id, igdbgenre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_igdbtheme (game_id INT NOT NULL, igdbtheme_id INT NOT NULL, INDEX IDX_75D39D43E48FD905 (game_id), INDEX IDX_75D39D432178B58B (igdbtheme_id), PRIMARY KEY (game_id, igdbtheme_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_game_collection (game_id INT NOT NULL, game_collection_id INT NOT NULL, INDEX IDX_6D216538E48FD905 (game_id), INDEX IDX_6D216538FBADCA96 (game_collection_id), PRIMARY KEY (game_id, game_collection_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_collection (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATE NOT NULL, slug VARCHAR(255) NOT NULL, igdb_id INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_mode (id INT AUTO_INCREMENT NOT NULL, name_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_platform (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, release_date DATE DEFAULT NULL, game_company_id INT DEFAULT NULL, INDEX IDX_92162FED7947DD3B (game_company_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_release (id INT AUTO_INCREMENT NOT NULL, release_date DATE NOT NULL, game_platform_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_B857C3221B30B6D (game_platform_id), INDEX IDX_B857C32E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE igdbgenre (id INT AUTO_INCREMENT NOT NULL, name_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE igdbtheme (id INT AUTO_INCREMENT NOT NULL, name_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE manga (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, manga_type_id INT NOT NULL, INDEX IDX_765A9E035BFB5992 (manga_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE manga_manga_genre (manga_id INT NOT NULL, manga_genre_id INT NOT NULL, INDEX IDX_9ACBD91D7B6461 (manga_id), INDEX IDX_9ACBD91D350F545C (manga_genre_id), PRIMARY KEY (manga_id, manga_genre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE manga_manga_theme (manga_id INT NOT NULL, manga_theme_id INT NOT NULL, INDEX IDX_8EEE0DED7B6461 (manga_id), INDEX IDX_8EEE0DED2E9BF3C4 (manga_theme_id), PRIMARY KEY (manga_id, manga_theme_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE manga_company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE manga_genre (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE manga_theme (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE manga_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE mbidtag (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, plex_id VARCHAR(255) DEFAULT NULL, mbid_tag_type_id INT DEFAULT NULL, INDEX IDX_EE9F47F38DC65F0 (mbid_tag_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE mbidtag_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, tmbd_id VARCHAR(255) DEFAULT NULL, plex_id VARCHAR(255) DEFAULT NULL, duration INT DEFAULT NULL, updated TINYINT NOT NULL, release_date DATE DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE movie_tmdbgenre (movie_id INT NOT NULL, tmdbgenre_id INT NOT NULL, INDEX IDX_ECCA38598F93B6FC (movie_id), INDEX IDX_ECCA38594AF4A685 (tmdbgenre_id), PRIMARY KEY (movie_id, tmdbgenre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE movie_show (id INT AUTO_INCREMENT NOT NULL, show_date DATETIME NOT NULL, user_id INT NOT NULL, movie_id INT NOT NULL, INDEX IDX_C168F80CA76ED395 (user_id), INDEX IDX_C168F80C8F93B6FC (movie_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE music (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, duration INT DEFAULT NULL, mbid VARCHAR(255) DEFAULT NULL, music_artist_id INT DEFAULT NULL, INDEX IDX_CD52224A655D9A59 (music_artist_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE music_mbidtag (music_id INT NOT NULL, mbidtag_id INT NOT NULL, INDEX IDX_2A6BD588399BBB13 (music_id), INDEX IDX_2A6BD588E4B5F40 (mbidtag_id), PRIMARY KEY (music_id, mbidtag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE music_artist (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE music_listen (id INT AUTO_INCREMENT NOT NULL, listen_at DATETIME NOT NULL, music_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_57FCA404399BBB13 (music_id), INDEX IDX_57FCA404A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE player_perspective (id INT AUTO_INCREMENT NOT NULL, name_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, plex_id VARCHAR(255) DEFAULT NULL, tvdb_id INT DEFAULT NULL, is_vf_name TINYINT NOT NULL, slug VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, first_aired DATE DEFAULT NULL, last_aired DATE DEFAULT NULL, next_aired DATE DEFAULT NULL, name_eng VARCHAR(255) DEFAULT NULL, last_season_name VARCHAR(255) DEFAULT NULL, next_aired_format VARCHAR(255) DEFAULT NULL, score INT DEFAULT NULL, serie_type_id INT NOT NULL, INDEX IDX_AA3A9334F1D5FF34 (serie_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie_tvdbtag (serie_id INT NOT NULL, tvdbtag_id INT NOT NULL, INDEX IDX_6DFC36A9D94388BD (serie_id), INDEX IDX_6DFC36A9DC09C6F4 (tvdbtag_id), PRIMARY KEY (serie_id, tvdbtag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie_tvdbgenre (serie_id INT NOT NULL, tvdbgenre_id INT NOT NULL, INDEX IDX_76842213D94388BD (serie_id), INDEX IDX_76842213C723E50A (tvdbgenre_id), PRIMARY KEY (serie_id, tvdbgenre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie_anime_theme (serie_id INT NOT NULL, anime_theme_id INT NOT NULL, INDEX IDX_FCE0B564D94388BD (serie_id), INDEX IDX_FCE0B564BCC2A6AD (anime_theme_id), PRIMARY KEY (serie_id, anime_theme_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie_anime_genre (serie_id INT NOT NULL, anime_genre_id INT NOT NULL, INDEX IDX_E8C56194D94388BD (serie_id), INDEX IDX_E8C56194A7560135 (anime_genre_id), PRIMARY KEY (serie_id, anime_genre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie_company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE serie_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE tmdbgenre (id INT AUTO_INCREMENT NOT NULL, name_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE tvdbgenre (id INT AUTO_INCREMENT NOT NULL, name_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE tvdbtag (id INT AUTO_INCREMENT NOT NULL, namename_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, tvdb_tag_type_id INT DEFAULT NULL, INDEX IDX_5965450EEA81001A (tvdb_tag_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE tvdbtag_type (id INT AUTO_INCREMENT NOT NULL, name_eng VARCHAR(255) DEFAULT NULL, name_fra VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, plex_name VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
