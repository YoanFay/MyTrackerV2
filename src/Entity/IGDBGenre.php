...
use App\Repository\IGDBGenreRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IGDBGenreRepository::class)]
class IGDBGenre
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\ManyToMany(targetEntity: Game::class, mappedBy: 'igdbGenres')]
